		...
		if ($id){
			switch ($id) {
				case 'checkbox':
					...
					return "<input type=\"checkbox\" id=\"checkbox\" class=\"icheck-input checkbox taxonid_{$data['value']}\" onchange=\"return AreAnyCheckboxesChecked({$data['value']});\" name=\"{$data['name']}[]\" value=\"{$data['value']}\" {$checked} >";
					break;
